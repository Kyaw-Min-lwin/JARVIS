...
__all__ = [
    'ISpRecoResult', 'SPEI_WORD_BOUNDARY', 'SVP_0', 'SREPrivate',
    'SpeechPropertyHighConfidenceThreshold', 'SPPHRASEELEMENT',
    'ISpeechLexiconPronunciation', 'SpMMAudioIn',
    'DISPID_SVSInputWordLength', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'ISpeechLexiconPronunciations',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'eLEXTYPE_PRIVATE5', 'DISPID_SVResume',
    'DISPID_SRSetPropertyString', 'SPDKL_CurrentConfig',
    'SP_VISEME_20', 'DISPID_SPISaveToMemory', 'SP_VISEME_11',
    'DISPID_SRGCmdLoadFromObject', 'SAFT8kHz16BitMono',
    'ISpeechPhraseProperty', 'SGDSInactive', 'SRSEDone',
    'DISPID_SLWWord', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SVEAudioLevel', 'SPEI_SENTENCE_BOUNDARY', 'SPCT_SLEEP',
    'SPAS_STOP', 'SAFT32kHz16BitStereo', 'SSFMCreate',
    'SAFT32kHz8BitStereo', 'DISPID_SPEAudioSizeTime', 'SPAUDIOSTATUS',
    'SVSFlagsAsync', 'DISPID_SPIEngineId', 'ISpRecoCategory',
    'DISPID_SABIMinNotification', 'DISPID_SOTCDefault',
    'DISPID_SRCRetainedAudioFormat', 'SAFTGSM610_44kHzMono',
    'SPAR_Medium', 'DISPID_SpeechPhoneConverter',
    'DISPID_SDKGetBinaryValue', 'DISPID_SPERequiredConfidence',
    'SPFILEMODE', 'SPVPRI_ALERT', 'DISPID_SABIBufferSize',
    'ISpeechGrammarRuleState', 'DISPID_SpeechLexiconWords',
    'SRAORetainAudio', 'SVEEndInputStream', 'DISPID_SLPs_NewEnum',
    'eLEXTYPE_PRIVATE10', 'SAFT16kHz16BitMono', 'SPSVerb',
    'SPEI_PHRASE_START', 'DISPID_SGRsFindRule',
    'SAFTNonStandardFormat', 'DISPID_SGRSTPropertyName', 'SpVoice',
    'SWTAdded', 'SpeechDataKeyLocation', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SGRAddState', 'SPDATAKEYLOCATION',
    'DISPID_SRCERecognitionForOtherContext', 'DISPID_SRIsShared',
    'SPCS_DISABLED', 'SLTUser', 'ISpeechGrammarRuleStateTransitions',
    'DISPID_SPRFirstElement', 'DISPID_SRRTLength', 'SPPS_RESERVED1',
    'SPEI_RESERVED1', 'DISPID_SVSCurrentStreamNumber',
    'ISpPhoneticAlphabetConverter', 'ISpeechRecoGrammar',
    'SVEWordBoundary', 'SpeechPropertyResponseSpeed',
    'SSTTTextBuffer', 'SPEI_RESERVED3',
    'DISPID_SpeechGrammarRuleStateTransition',
    'ISpStreamFormatConverter', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SPIStartTime', 'SVP_4', 'ISpeechPhoneConverter',
    'SpMemoryStream', 'eLEXTYPE_PRIVATE3', 'DISPID_SOTs_NewEnum',
    'SPPS_Verb', 'DISPID_SADefaultFormat',
    'Speech_StreamPos_RealTime', 'ISpeechPhraseElements',
    'SpeechCategoryAudioIn', 'SPEI_RECO_OTHER_CONTEXT',
    'SpeechSpecialTransitionType', 'DISPID_SOTRemove',
    'DISPID_SGRSAddSpecialTransition', 'SRTAutopause',
    'ISpGrammarBuilder', 'SPWORDTYPE', 'SPAUDIOOPTIONS',
    'SPEI_SOUND_START', 'SECLowConfidence', 'SpeechCategoryVoices',
    'SPDKL_LocalMachine', 'SpeechTokenKeyUI', 'eLEXTYPE_PRIVATE20',
    'SpeechDictationTopicSpelling', 'DISPID_SRCVoice', 'SPAO_NONE',
    'SpeechVoicePriority', 'SAFT12kHz16BitMono',
    'SpeechRegistryLocalMachineRoot', 'SP_VISEME_10',
    'DISPID_SLPsItem', 'DISPID_SpeechWaveFormatEx', 'SDTAudio',
    'SECFDefault', 'SpCustomStream', 'SVP_12', 'DISPID_SRCERequestUI',
    'SLTApp', 'DISPID_SBSSeek', 'DISPID_SLGenerationId',
    'eLEXTYPE_PRIVATE19', 'DISPID_SVVolume',
    'DISPIDSPTSI_SelectionOffset', 'IEnumSpObjectTokens', 'SVSFIsXML',
    'DISPID_SpeechGrammarRules', 'SAFT11kHz16BitMono',
    'SECHighConfidence', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SRCEventInterests', 'SAFT11kHz16BitStereo',
    'SAFTNoAssignedFormat', 'DISPID_SRCEAudioLevel',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SRSSupportedLanguages',
    'DISPID_SGRsDynamic', 'SPPS_Noncontent', 'SpeechAudioVolume',
    'eLEXTYPE_USER', 'DISPID_SpeechRecoResult',
    'DISPID_SPEDisplayAttributes', 'ISpeechPhraseElement',
    'IInternetSecurityMgrSite', 'SPEI_START_INPUT_STREAM',
    'DISPID_SpeechPhraseRules', 'DISPID_SVEWord',
    'SPEI_SR_RETAINEDAUDIO', 'SRERecoOtherContext', 'SPLEXICONTYPE',
    'SpeechEngineConfidence', 'DISPID_SRGRecoContext',
    'DISPID_SRRAudio', 'SASPause', 'eWORDTYPE_ADDED',
    'STCInprocHandler', 'DISPID_SLPLangId', 'SPPS_RESERVED4',
    'SVEViseme', 'DISPID_SRRGetXMLResult', 'SP_VISEME_5',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SASCurrentSeekPosition',
    'SPFM_CREATE_ALWAYS', 'DISPID_SVESentenceBoundary',
    'DISPID_SGRsCount', 'DISPID_SPPs_NewEnum',
    'DISPID_SOTCreateInstance', 'SWPKnownWordPronounceable',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SRAudioInputStream',
    'ISpeechObjectTokenCategory', 'SRTReSent', 'SPSHORTCUTTYPE',
    'SPEI_END_INPUT_STREAM', 'ISpDataKey',
    'DISPID_SpeechRecoResultTimes', 'SPPS_Unknown',
    'SAFT44kHz16BitMono', 'DISPID_SVSRunningState',
    'SpeechAudioFormatGUIDWave', 'SAFT16kHz8BitStereo',
    'ISpRecognizer2', 'DISPID_SLRemovePronunciationByPhoneIds',
    'SPEI_ADAPTATION', 'DISPID_SMSAMMHandle',
    'DISPID_SOTIsUISupported', 'eLEXTYPE_PRIVATE13',
    'DISPID_SPRuleChildren', 'SPEVENTENUM',
    'DISPID_SLGetPronunciations', 'SREPropertyStringChange',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SPIRule', 'DISPID_SOTId',
    'SpeechCategoryRecognizers', 'DISPID_SVSLastResult',
    'SPRULESTATE', 'SGSDisabled', 'DISPID_SOTGetAttribute',
    'IInternetSecurityManager', 'SPEI_REQUEST_UI',
    'DISPID_SRRGetXMLErrorInfo', 'SpPhoneticAlphabetConverter',
    'DISPID_SpeechVoice', 'SpeechRecoContextState',
    'ISpeechXMLRecoResult', 'ISpeechAudioStatus',
    'SWPUnknownWordUnpronounceable', 'DISPID_SRCRequestedUIType',
    'SAFT16kHz8BitMono', 'DISPID_SRRSpeakAudio',
    'DISPID_SLWPronunciations', '_SPAUDIOSTATE',
    'SpeechAddRemoveWord', 'DISPID_SpeechAudioFormat',
    'SpInprocRecognizer', 'SP_VISEME_6', 'ISpeechMemoryStream',
    'DISPID_SVGetVoices', 'SPSUnknown', 'SpeechPropertyResourceUsage',
    'SPCT_SUB_DICTATION', 'SVP_17', 'DISPID_SLGetGenerationChange',
    'eLEXTYPE_MORPHOLOGY', 'DISPID_SpeechRecoContextEvents',
    'SPINTERFERENCE_TOOQUIET', 'SVP_6',
    'DISPID_SLAddPronunciationByPhoneIds', 'ISpeechCustomStream',
    'SPPS_Noun', 'SPGS_DISABLED', 'ISpObjectTokenCategory',
    'DISPID_SVSLastStreamNumberQueued', 'SDTAll',
    'SPRECOGNIZERSTATUS', 'SLODynamic', 'SPSERIALIZEDPHRASE',
    'SPEI_SR_PRIVATE', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SVAlertBoundary', 'DISPID_SPCLangId',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SPPName', 'SPVOICESTATUS',
    'DISPID_SLGetWords', 'SAFTADPCM_11kHzStereo',
    'DISPID_SpeechRecoResult2', 'DISPID_SpeechPhraseInfo',
    'SPFM_OPEN_READONLY', 'SpShortcut', 'SLOStatic', 'SPLOADOPTIONS',
    'DISPID_SPEEngineConfidence', 'DISPID_SMSALineId',
    'DISPID_SRRTOffsetFromStart', 'SREStateChange',
    ...
    'DISPID_SRCSetAdaptationData', 'DISPID_SLPSymbolic',
    'DISPID_SOTCGetDataKey', 'SPINTERFERENCE_TOOSLOW', 'ISpeechAudio',
    'eLEXTYPE_USER_SHORTCUT', 'SPSHT_OTHER',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SRCState', 'SREInterference',
    'eLEXTYPE_RESERVED6', 'SPSHORTCUTPAIR',
    'SpeechRecoProfileProperties', 'SPPS_RESERVED2', 'SpeechWordType',
    'SAFTCCITT_uLaw_8kHzMono', 'SpeechGrammarTagDictation',
    'SRTStandard', '__MIDL_IWinTypes_0009', 'SFTInput',
    'DISPID_SAFGuid', 'SAFTADPCM_8kHzMono', 'SPRULE',
    'DISPID_SLAddPronunciation', 'DISPID_SLPPartOfSpeech',
    'DISPID_SRGRules', 'SAFT8kHz8BitMono', 'ISpProperties',
    'SPRECORESULTTIMES', 'SVSFIsFilename', 'SINoSignal',
    'DISPID_SRCEInterference', 'SVP_21', 'SVEPrivate', 'ISpEventSink',
    'SPSLMA', 'DISPID_SRRSetTextFeedback', 'DISPID_SRCEBookmark',
    'SPSMF_SAPI_PROPERTIES', 'SPGRAMMARSTATE', 'SPWORDPRONUNCIATION',
    'DISPID_SpeechVoiceEvent', 'DISPID_SpeechRecoContext',
    'SAFT24kHz8BitStereo', 'SPSNotOverriden', 'SVEVoiceChange',
    'SDA_No_Trailing_Space', 'SAFT12kHz8BitMono', 'eLEXTYPE_PRIVATE6',
    'eWORDTYPE_DELETED', 'SPWORD', 'DISPID_SRGCommit',
    'DISPID_SRRAlternates', 'SGLexicalNoSpecialChars',
    'eLEXTYPE_PRIVATE11', 'SPPHRASEPROPERTY', 'DISPIDSPRG',
    'DISPID_SVSkip', 'SPSHORTCUTPAIRLIST', 'SVP_19',
    'SpeechVisemeType', 'ISpeechTextSelectionInformation',
    'DISPID_SVGetAudioInputs', 'DISPID_SPERetainedStreamOffset',
    'ISpeechVoice', 'IEnumString', 'SpeechGrammarTagWildcard',
    'SPAUDIOSTATE', 'DISPID_SPEs_NewEnum', 'SAFTGSM610_8kHzMono',
    'SPWF_INPUT', 'DISPID_SLWType', 'UINT_PTR', 'SpeechAudioState',
    'DISPID_SWFEChannels', 'SP_VISEME_14',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SPIAudioSizeBytes',
    'ISpeechObjectToken', 'DISPID_SRSClsidEngine', 'SPEI_SOUND_END',
    '_ISpeechRecoContextEvents', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SAFTADPCM_11kHzMono', 'SSSPTRelativeToCurrentPosition',
    'SDTDisplayText', 'SWTDeleted', 'DISPID_SPPsItem',
    'DISPID_SpeechObjectTokens', 'SpStreamFormatConverter',
    'DISPID_SRCVoicePurgeEvent', 'eLEXTYPE_PRIVATE9',
    'SpeechRuleAttributes', 'STCInprocServer',
    'SpeechGrammarWordType', 'SPEI_HYPOTHESIS', 'SpAudioFormat',
    'SAFT12kHz16BitStereo', 'ISpStreamFormat', 'SPEI_MIN_TTS',
    'SpeechVisemeFeature', 'DISPID_SGRsAdd', 'SPFM_NUM_MODES',
    'DISPID_SPRsCount', 'SPEI_INTERFERENCE', 'ISpeechFileStream',
    'SDKLLocalMachine', 'SpeechVoiceEvents', 'SPRST_ACTIVE',
    'SPEI_MIN_SR', 'SPEI_END_SR_STREAM', 'SPINTERFERENCE_NOSIGNAL',
    'SPDKL_DefaultLocation', 'DISPID_SOTCategory', 'DISPID_SVStatus',
    'DISPID_SRGCmdLoadFromFile', 'SVF_None',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SGRSTNextState',
    'SpeechAudioFormatGUIDText', 'SPSEMANTICERRORINFO', 'SAFTText',
    'SRAExport', 'DISPID_SOTDisplayUI', 'SAFTCCITT_ALaw_11kHzMono',
    'DISPID_SpeechPhraseElements', 'SpeechPartOfSpeech',
    'DISPID_SDKSetLongValue', 'SPSModifier', 'DISPID_SOTsItem',
    'SDKLCurrentUser', 'SVP_1', 'DISPID_SPRuleEngineConfidence',
    'SASClosed', 'eLEXTYPE_PRIVATE2', 'SAFTCCITT_uLaw_44kHzStereo',
    'SVEAllEvents', 'DISPID_SpeechObjectTokenCategory', 'SGRSTTWord',
    'SPSInterjection', 'SPEI_PROPERTY_STRING_CHANGE',
    'SpPhoneConverter', 'DISPID_SAEventHandle', 'SPAR_Unknown',
    'DISPID_SPIElements', 'DISPID_SAFSetWaveFormatEx',
    'SVSFParseSsml', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SRCESoundStart', 'SAFT11kHz8BitMono',
    'SAFT24kHz16BitMono', 'SPRST_NUM_STATES',
    'SpeechPropertyAdaptationOn', 'ISpeechRecognizer',
    'DISPID_SpeechLexiconProns', 'DISPID_SpeechAudioStatus',
    'SRAInterpreter', 'SAFTCCITT_uLaw_22kHzStereo',
    'DISPID_SPAPhraseInfo', 'DISPID_SVEStreamStart',
    'Speech_StreamPos_Asap', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SRSAudioStatus', 'SAFTADPCM_8kHzStereo',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SRRTimes',
    '_ISpeechVoiceEvents', 'DISPID_SRState',
    'DISPID_SPIAudioSizeTime', 'SpeechDisplayAttributes',
    'SPPS_Modifier', 'eLEXTYPE_PRIVATE1', 'SPWORDLIST',
    'SpMMAudioEnum', 'DISPID_SPPChildren', 'SPEI_RECO_STATE_CHANGE',
    'SREPropertyNumChange', 'SPPHRASEREPLACEMENT',
    'SpeechGrammarState', 'SpeechRetainedAudioOptions',
    'DISPID_SPEAudioTimeOffset', 'SSTTWildcard',
    'DISPID_SRRecognizer', 'ISpPhoneConverter', 'SRSActive',
    'SpObjectToken', 'DISPID_SOTCSetId', 'WAVEFORMATEX',
    'SPRECOCONTEXTSTATUS', 'SBONone', 'SREAllEvents',
    'DISPID_SpeechDataKey', 'DISPID_SRGIsPronounceable',
    'DISPID_SGRSTText', 'SPRS_ACTIVE', 'ISpeechBaseStream',
    'SAFT22kHz8BitStereo', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SPIGetDisplayAttributes',
    'SRTExtendableParse', 'DISPID_SVSLastBookmarkId',
    'SPRST_INACTIVE_WITH_PURGE', 'SASStop', 'SVP_10', 'SPEI_MAX_TTS',
    'SVSFPersistXML', 'SpeechVoiceCategoryTTSRate',
    'SAFTCCITT_ALaw_22kHzMono', 'SPPS_Function', 'eLEXTYPE_RESERVED4',
    'DISPID_SWFEBitsPerSample', 'SpStream', 'SASRun',
    'SVSFPurgeBeforeSpeak', 'SpeechCategoryAudioOut',
    'SRSActiveAlways', 'eLEXTYPE_PRIVATE12',
    'DISPID_SpeechRecognizerStatus', 'SpeechRunState',
    'ISpeechRecoContext', 'ISpeechPhraseAlternate', 'SITooSlow',
    'SDTRule', 'ISpNotifySource', 'DISPID_SGRSAddWordTransition',
    'SPXRO_Alternates_SML', 'SpeechCategoryAppLexicons',
    'eLEXTYPE_RESERVED9', 'ISpXMLRecoResult', 'DISPID_SPEsItem',
    'SpeechTokenValueCLSID', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SP_VISEME_4', 'DISPID_SGRId', 'SPBINARYGRAMMAR',
    'SVSFUnusedFlags', 'DISPID_SpeechPhraseAlternate',
    'SpCompressedLexicon', 'ISpeechRecoResult2', 'SVP_3',
    'DISPID_SPIRetainedSizeBytes', 'SAFTCCITT_ALaw_22kHzStereo',
    'SP_VISEME_9', 'DISPID_SOTGetDescription', 'ISpRecoGrammar',
    'ISpRecoContext2', 'SSFMOpenReadWrite', 'DISPID_SPAs_NewEnum',
    'DISPID_SPRDisplayAttributes', 'SVP_13', 'SPPARTOFSPEECH',
    'STCAll', 'SpeechStreamFileMode', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPID_SVSpeakStream', 'DISPID_SABufferInfo',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SWFEFormatTag',
    'DISPID_SRCCreateGrammar', 'SREFalseRecognition',
    'eLEXTYPE_PRIVATE8', 'SREBookmark', 'DISPID_SGRSTPropertyValue',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SAFGetWaveFormatEx',
    'DISPID_SGRSTsItem', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SVEVoiceChange', 'DISPID_SPEActualConfidence',
    'SP_VISEME_8', 'SPWT_DISPLAY', 'ISpeechVoiceStatus', 'SBOPause',
    'tagSTATSTG', 'DISPID_SDKGetlongValue', 'DISPIDSPTSI',
    'SVSFParseSapi', 'SP_VISEME_2', 'DISPID_SVSVisemeId',
    'ISpeechLexiconWord', 'DISPID_SRGReset',
    'DISPID_SRCEPropertyStringChange', 'SPWF_SRENGINE',
    'DISPID_SDKSetBinaryValue', 'SpeechAllElements', 'DISPID_SVVoice',
    'DISPID_SpeechGrammarRule', 'DISPID_SBSWrite',
    'DISPID_SASNonBlockingIO', 'SP_VISEME_0', 'SPEVENTSOURCEINFO',
    'DISPID_SOTGetStorageFileName', 'DISPID_SVEViseme',
    'DISPID_SBSFormat', 'SREAudioLevel', 'DISPID_SRSetPropertyNumber',
    'eLEXTYPE_PRIVATE14', 'SpeechTokenContext', 'SSSPTRelativeToEnd',
    'ISpeechLexicon', 'SGLexical', 'STSF_FlagCreate',
    'ISpRecoContext', 'DISPID_SRCEEnginePrivate', 'DISPID_SAVolume',
    'LONG_PTR', 'DISPID_SRCreateRecoContext', 'SVSFParseMask',
    'SRSEIsSpeaking', 'ISpPhraseAlt',
    'SPINTERFERENCE_LATENCY_WARNING', 'ISpeechDataKey', 'ISpStream',
    'SSFMOpenForRead', 'DISPID_SPIAudioStreamPosition',
    'DISPID_SpeechCustomStream', 'ISpRecognizer', 'SPVPRI_OVER',
    'DISPID_SASState', 'SAFTCCITT_uLaw_8kHzStereo', 'SPGS_EXCLUSIVE',
    'DISPID_SRCPause', 'SAFTCCITT_uLaw_11kHzMono',
    'DISPID_SASCurrentDevicePosition', 'SGSExclusive',
    'SAFT22kHz16BitStereo', 'SAFT24kHz8BitMono',
    'DISPID_SOTMatchesAttributes',
    'SpeechGrammarRuleStateTransitionType', 'SPPS_RESERVED3',
    'SpeechDiscardType', 'SPBOOKMARKOPTIONS', 'SVP_14',
    'ISpMMSysAudio', 'DISPID_SRCRecognizer', 'SECFIgnoreWidth',
    'tagSPTEXTSELECTIONINFO', 'DISPID_SLWsCount', 'SPBO_PAUSE',
    'SPVPRI_NORMAL', 'DISPID_SPPsCount', 'DISPID_SPARecoResult',
    'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SWFEExtraData',
    'DISPID_SPRulesCount', 'SPPHRASE', 'DISPID_SLPPhoneIds',
    'SPINTERFERENCE', 'ISpeechPhraseReplacement', 'SPEI_TTS_BOOKMARK',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SPAsCount',
    'SAFTADPCM_22kHzMono', 'SPEI_SR_BOOKMARK',
    'DISPID_SpeechVoiceStatus', 'SREAdaptation', 'SRAImport',
    'DISPID_SASFreeBufferSpace', 'DISPID_SRCERecognition', 'SPEVENT',
    'ISpeechRecoResultDispatch', 'SFTSREngine',
    'DISPID_SPIReplacements', 'SPAO_RETAIN_AUDIO',
    'DISPID_SDKSetStringValue', 'SPWORDPRONOUNCEABLE', 'SPCS_ENABLED',
    'SAFT22kHz8BitMono', 'ISpAudio', 'SpFileStream',
    'DISPID_SPIProperties', 'SVF_Emphasis', 'DISPID_SpeechBaseStream',
    'DISPID_SpeechPhraseReplacements', 'SAFTTrueSpeech_8kHz1BitMono',
    'DISPID_SVWaitUntilDone', 'DISPID_SVSpeakCompleteEvent',
    'SPINTERFERENCE_TOOFAST', 'STSF_LocalAppData',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SRDisplayUI',
    'SpeechRecoEvents', 'DISPID_SRRRecoContext', 'SPCT_DICTATION',
    'SVP_18', 'ISpLexicon', 'DISPID_SDKEnumValues', 'SP_VISEME_16',
    'SPEI_RECOGNITION', 'SPLO_DYNAMIC', 'DISPID_SPPParent',
    'DISPID_SPPEngineConfidence', 'SRSInactive', 'DISPID_SAStatus',
    'SAFTDefault', 'SAFT22kHz16BitMono', 'SpeechTokenShellFolder',
    'SAFT8kHz8BitStereo', 'SPAR_Low', 'SPSHT_NotOverriden',
    'SRADefaultToActive', 'SECFEmulateResult',
    'Speech_Default_Weight', 'DISPID_SPEsCount',
    'DISPID_SpeechAudioBufferInfo', 'SVEBookmark',
    'ISpeechPhraseRule', 'SECFIgnoreCase', 'DISPID_SMSGetData',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SABIEventBias',
    'eLEXTYPE_RESERVED8', 'SPAR_High', 'DISPID_SGRAddResource',
    'ISpeechPhraseInfo', 'SPSHT_EMAIL', 'DISPID_SPRText',
    'eLEXTYPE_RESERVED7', 'DISPID_SpeechLexiconWord', 'SPBO_AHEAD',
    'DISPID_SFSOpen', 'DISPID_SRGetPropertyNumber',
    'DISPID_SVIsUISupported', 'SGRSTTDictation', 'eLEXTYPE_PRIVATE17',
    'SpeechInterference', 'SAFTCCITT_ALaw_8kHzMono', 'SVSFVoiceMask',
    'DISPID_SPRules_NewEnum', 'DISPID_SRGState', 'STCRemoteServer',
    'SpMMAudioOut', 'DISPID_SOTCId', 'DISPID_SVEventInterests',
    'DISPID_SRRTTickCount', 'ISpShortcut', 'DISPID_SRCBookmark',
    'DISPID_SWFEBlockAlign', 'SRERecognition', 'DISPID_SVRate',
    'IStream', 'SPVISEMES', 'DISPID_SRCEHypothesis', 'eLEXTYPE_APP',
    'DISPID_SVPause', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SPEI_VOICE_CHANGE', 'DISPID_SGRSAddRuleTransition',
    'DISPID_SVSPhonemeId', 'DISPID_SPIGrammarId', 'SPEI_RESERVED2',
    'SDA_Consume_Leading_Spaces', 'DISPID_SGRs_NewEnum', 'SVP_5',
    'DISPID_SWFESamplesPerSec', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SRGCmdLoadFromMemory', 'SRTSMLTimeout',
    'DISPID_SpeechXMLRecoResult', 'SVP_20', 'SPTEXTSELECTIONINFO',
    'DISPID_SLPType', 'DISPID_SRGDictationLoad',
    'SpeechRecognitionType', 'SDA_Two_Trailing_Spaces',
    'tagSPPROPERTYINFO', 'DISPID_SVEPhoneme', 'DISPID_SRRAudioFormat',
    'DISPID_SPEDisplayText', 'DISPID_SPAStartElementInResult',
    'SPPS_NotOverriden', 'SpeechVoiceSpeakFlags', 'SP_VISEME_1',
    'DISPID_SGRSTPropertyId', 'DISPID_SPCIdToPhone',
    'eLEXTYPE_VENDORLEXICON', 'ISpeechRecoResultTimes',
    'DISPID_SAFType', 'ISpObjectToken', 'SPWT_LEXICAL',
    'SAFT48kHz16BitMono', 'DISPID_SRCResume',
    'DISPID_SRSCurrentStreamPosition', 'SPRS_INACTIVE',
    'DISPID_SPPId', 'DISPID_SRGCmdSetRuleIdState',
    'SDA_One_Trailing_Space', 'SPAUDIOBUFFERINFO',
    'DISPID_SRCESoundEnd', 'SSTTDictation',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SRCEPhraseStart', 'DISPID_SRGCmdSetRuleState',
    'SP_VISEME_15', 'SAFT8kHz16BitStereo', 'SREPhraseStart',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SRRSaveToMemory',
    'SVP_15', 'SPLO_STATIC', 'SAFT44kHz8BitStereo',
    'DISPID_SPACommit', 'DISPID_SPRsItem', 'DISPID_SRGetFormat',
    'SP_VISEME_17', 'DISPID_SGRSTType', 'SPCT_SUB_COMMAND',
    'DISPID_SVEStreamEnd', 'SAFTADPCM_22kHzStereo', 'SRAONone',
    'SGRSTTRule', 'DISPID_SRRTStreamTime', 'DISPID_SVAudioOutput',
    'ISpeechAudioFormat', 'DISPID_SVAudioOutputStream',
    'ISpeechPhraseAlternates', 'SPPHRASERULE', 'DISPID_SPRs_NewEnum',
    'SP_VISEME_18', 'Speech_Max_Word_Length',
    'SpeechEmulationCompareFlags', 'eLEXTYPE_PRIVATE18',
    'DISPID_SFSClose', 'ISpeechPhraseInfoBuilder',
    'SpeechEngineProperties', 'SAFTExtendedAudioFormat',
    'SPWT_PRONUNCIATION', 'SpNullPhoneConverter',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SPRuleNumberOfElements',
    'SVF_Stressed', 'DISPID_SOTDataKey', 'SGRSTTWildcard',
    'SP_VISEME_3', 'DISPID_SVPriority', 'ISpNotifySink',
    'DISPID_SRProfile', 'SAFTGSM610_22kHzMono', 'SPCT_COMMAND',
    'DISPID_SpeechPhraseRule', 'SPSSuppressWord', 'SVP_16',
    'SGRSTTEpsilon', 'DISPID_SpeechPhraseAlternates',
    'DISPID_SVSpeak', 'SPEI_MAX_SR', 'DISPID_SPAsItem',
    'SAFTCCITT_ALaw_44kHzStereo', 'SRESoundEnd', 'SpeechRuleState',
    'SPDKL_CurrentUser', 'SAFT48kHz16BitStereo', 'DISPID_SGRsItem',
    'SPRST_INACTIVE', 'ISpObjectWithToken', 'SpWaveFormatEx',
    'SPFM_CREATE', 'DISPID_SLWsItem', 'SAFTCCITT_ALaw_11kHzStereo',
    'SpeechFormatType', 'DISPID_SPELexicalForm',
    'DISPID_SCSBaseStream', 'SREHypothesis', 'SpPhraseInfoBuilder',
    'DISPID_SPRuleParent', 'DISPID_SRGCmdLoadFromResource',
    'DISPID_SVSInputWordPosition', 'SGDisplay', 'SREStreamEnd',
    'SpResourceManager', 'SPGRAMMARWORDTYPE',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SRCRetainedAudio',
    'DISPID_SpeechLexicon', 'SAFTADPCM_44kHzMono',
    'ISpeechAudioBufferInfo', 'SITooLoud',
    'DISPID_SRGDictationSetState', 'STCLocalServer',
    'DISPID_SPRuleFirstElement', 'SPEI_PHONEME', 'SVSFNLPSpeakPunc',
    'SPEI_VISEME', 'SVSFIsNotXML', 'DISPID_SRRPhraseInfo',
    'SPPROPERTYINFO', 'DISPIDSPTSI_SelectionLength', 'SPSNoun',
    'SPWAVEFORMATTYPE', 'ISpPhrase', 'SPEI_TTS_AUDIO_LEVEL',
    'DISPID_SPANumberOfElementsInResult', 'SSFMCreateForWrite',
    'DISPID_SVEEnginePrivate', 'SP_VISEME_21',
    'DISPID_SRCEAdaptation', 'SP_VISEME_12', 'DISPID_SPILanguageId',
    'SRSInactiveWithPurge', 'SRTEmulated', 'SAFT32kHz16BitMono',
    'SAFT48kHz8BitStereo', 'SRARoot', 'SWPUnknownWordPronounceable',
    'SGDSActiveUserDelimited', 'DISPID_SPPNumberOfElements',
    'SGDSActiveWithAutoPause', 'SDTLexicalForm',
    'DISPID_SGRAttributes', 'SPCONTEXTSTATE', 'SSSPTRelativeToStart',
    'SpeechCategoryRecoProfiles', 'DISPID_SPPValue',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SPEPronunciation',
    'SpeechLexiconType', 'ISpeechPhraseProperties',
    'eLEXTYPE_RESERVED10', 'ISpVoice', 'DISPID_SVSLastBookmark',
    'DISPID_SRAudioInput', 'DISPID_SPIGetText', 'DISPID_SPRulesItem',
    'SDTAlternates', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SPGS_ENABLED', 'SPSMF_UPS', 'ISpEventSource', 'SVPOver',
    'SAFT48kHz8BitMono', 'ISpeechWaveFormatEx', 'SPPS_SuppressWord',
    'DISPID_SpeechPhraseProperty', 'DISPID_SLRemovePronunciation',
    'SpObjectTokenCategory', 'DISPID_SASetState', 'SAFT32kHz8BitMono',
    'SDKLDefaultLocation', 'DISPID_SVGetProfiles',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SpeechMemoryStream',
    'DISPID_SGRSTs_NewEnum', 'SGRSTTTextBuffer',
    'DISPID_SPRNumberOfElements', 'SPXRO_SML', 'ISequentialStream',
    'SITooFast', 'SDTReplacement', 'DISPID_SRGId',
    'SpNotifyTranslator', 'SVP_11', 'SVSFNLPMask',
    'SPXMLRESULTOPTIONS', 'DISPID_SRGetRecognizers', 'SRCS_Enabled',
    'DISPID_SREmulateRecognition', 'SPINTERFERENCE_NONE',
    'SVSFDefault', 'ISpeechPhraseReplacements', 'SPSERIALIZEDRESULT',
    'SVESentenceBoundary', 'SRCS_Disabled',
    'DISPID_SABufferNotifySize', 'SPADAPTATIONRELEVANCE',
    'DISPID_SRGSetTextSelection', 'SpeechRecognizerState',
    'SpSharedRecoContext', 'DISPID_SpeechAudio',
    'DISPID_SRCEStartStream', 'SP_VISEME_19', 'SVP_9',
    'SECFIgnoreKanaType', 'DISPID_SPPFirstElement', 'STSF_AppData',
    'SINoise', 'DISPID_SLPsCount', 'SpeechBookmarkOptions',
    'SITooQuiet', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SVGetAudioOutputs',
    'DISPID_SpeechPhraseProperties', 'ISpeechRecognizerStatus',
    'DISPID_SpeechObjectToken', 'DISPID_SpeechFileStream',
    'SPRECOSTATE', 'DISPID_SVEBookmark', 'Speech_Max_Pron_Length',
    'DISPID_SGRsCommit', 'DISPID_SPIEnginePrivateData',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SDKGetStringValue',
    'SRERequestUI', 'SVEAudioLevel', 'SpTextSelectionInformation',
    'DISPID_SGRSTRule', 'SAFT44kHz16BitStereo',
    'ISpeechResourceLoader', 'DISPID_SDKCreateKey',
    'SpeechAudioProperties', 'eLEXTYPE_PRIVATE16', '_RemotableHandle',
    'SpeechPropertyNormalConfidenceThreshold', 'SPPS_Interjection',
    'SPEI_TTS_PRIVATE', 'DISPID_SPPConfidence', 'ISpResourceManager',
    'SPCATEGORYTYPE', 'DISPID_SGRClear', 'SpInProcRecoContext',
    'SECNormalConfidence', 'SDKLCurrentConfig', 'DISPID_SVDisplayUI',
    'SDTProperty', 'DISPID_SGRInitialState', 'SPVPRIORITY',
    'SVEPhoneme', 'DISPID_SpeechGrammarRuleState', 'SRATopLevel',
    'SPAS_RUN', 'SPSFunction', 'DISPID_SRStatus', 'SINone',
    'DISPID_SPCPhoneToId', 'DISPID_SGRSTsCount', 'STSF_CommonAppData',
    'DISPID_SOTRemoveStorageFileName', 'SpUnCompressedLexicon',
    'SpeechLoadOption', 'ISpeechLexiconWords', 'ISpSerializeState',
    'DISPID_SpeechPhraseReplacement', 'SGDSActive',
    'DISPID_SLWs_NewEnum', 'DISPID_SDKDeleteKey', 'SP_VISEME_7',
    'SPINTERFERENCE_NOISE', 'ISpeechPhraseRules',
    'SPEI_SR_AUDIO_LEVEL', 'SVPNormal', 'ISpeechGrammarRule',
    'SpeechTokenIdUserLexicon',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SRESoundStart',
    'SVP_8', 'eLEXTYPE_PRIVATE4', 'SP_VISEME_13', 'SpLexicon',
    'SpeechUserTraining', 'DISPID_SLWLangId', 'SAFT24kHz16BitStereo',
    'SPEI_START_SR_STREAM', 'SPFM_OPEN_READWRITE',
    'DISPID_SRGetPropertyString', 'SPAS_PAUSE',
    'SpeechAudioFormatType', 'SVP_7', 'ISpeechObjectTokens',
    'SECFNoSpecialChars', 'SAFT44kHz8BitMono',
    'SAFTCCITT_uLaw_11kHzStereo', 'SAFTGSM610_11kHzMono',
    'SRADynamic', 'DISPID_SMSADeviceId', 'SDTPronunciation',
    'DISPID_SDKOpenKey', 'SPPS_LMA', 'DISPID_SOTsCount',
    'DISPID_SVSInputSentencePosition', 'SAFT16kHz16BitStereo',
    'DISPID_SMSSetData', 'SGSEnabled', 'SREStreamStart',
    'ISpeechGrammarRules', 'ISpPhoneticAlphabetSelection',
    'DISPID_SVSInputSentenceLength', 'SPSEMANTICFORMAT',
    'SPEI_UNDEFINED', 'SpeechPropertyComplexResponseSpeed',
    'DISPID_SPRuleName', 'DISPID_SGRSTransitions', 'SPEI_RESERVED6',
    'DISPID_SRCEPropertyNumberChange', 'SPBO_NONE',
    'DISPID_SGRSTWeight', 'SpeechRegistryUserRoot',
    'DISPID_SPEAudioSizeBytes', 'ISpeechRecoResult', 'SPEI_RESERVED5',
    'SAFT11kHz8BitStereo', 'SVP_2', 'DISPID_SpeechRecognizer',
    'ISpNotifyTranslator', 'SpeechCategoryPhoneConverters',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SDKEnumKeys', 'ISpRecognizer3',
    'SVPAlert', 'SAFTADPCM_44kHzStereo', 'SVEStartInputStream',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SRCEFalseRecognition',
    'SpeechPropertyLowConfidenceThreshold', 'SVSFParseAutodetect',
    'DISPID_SRCEEndStream', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SPRuleId',
    'SpeechWordPronounceable', 'DISPID_SGRSRule',
    'SpeechTokenKeyAttributes', 'DISPID_SPRuleConfidence',
    'SPAS_CLOSED', 'SGPronounciation', 'ISpeechMMSysAudio',
    'DISPID_SOTSetId', 'ISpRecoGrammar2', 'SPSTREAMFORMATTYPE',
    'DISPID_SBSRead', 'DISPID_SGRName', 'SPSHT_Unknown',
    'SpeechTokenKeyFiles', 'DISPID_SRGDictationUnload',
    'SpeechMicTraining', 'SpeechStreamSeekPositionType',
    'SAFT12kHz8BitStereo', 'DISPID_SpeechPhraseElement'
]

_check_version('1.2.1', 1700058672.518144)
